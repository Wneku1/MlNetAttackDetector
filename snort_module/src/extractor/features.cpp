...
timeval Features::getStartTime() { return startTime; }
...
int Features::getPayloadSize() { return this->payloadSize; }
void Features::setPayloadSize(uint16_t dsize) { this->payloadSize = dsize; }

float Features::getAvgPacketLen() { return this->avgPktSlen; }
